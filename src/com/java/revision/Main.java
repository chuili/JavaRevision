...
public class Main {
    ...
    public static void main(String[] args) {
        int[] data = {2,2,5,50,1};
        JavaPractice.largeButMinFreq(data, data.length);
